...
interface AdminSidebarProps {
  activeSection: 'dashboard' | 'analytics' | 'users' | 'templates' | 'testimonials' | 'settings' | 'meme-review' | 'contact' | 'support' | 'meme-management';
  setActiveSection: (section: 'dashboard' | 'analytics' | 'users' | 'templates' | 'testimonials' | 'settings' | 'meme-review' | 'contact' | 'support' | 'meme-management') => void;
}
